/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 4cadf2e078c40767485d31f84d7a2a9d)
...
interface __BaseEnv_Env {
	...
	MATCH: DurableObjectNamespace<import("./worker/index").MatchDO>;
	DAILY: DurableObjectNamespace<import("./worker/index").DailyDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "MatchDO" | "DailyDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "SESSION_SECRET" | "SLACK_WEBHOOK_URL" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT">> {}
}
